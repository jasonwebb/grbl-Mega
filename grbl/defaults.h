...
// TODO: Calculate and verify all values
  ...
  // Settings only for custom wall plotter using RAMPS
  ...
  #define DEFAULT_Z_STEPS_PER_MM 1000.0  // mm - [Z AXIS NOT USED]
  #define DEFAULT_X_MAX_RATE 6000.0  // mm/min
  #define DEFAULT_Y_MAX_RATE 6000.0  // mm/min
  #define DEFAULT_Z_MAX_RATE 6000.0  // mm/min - [Z AXIS NOT USED]
  ...
  #define DEFAULT_Z_ACCELERATION (250.0*60*60)  // 250*60*60 mm/min^2 = 250 mm/sec^2 - [Z AXIS NOT USED]
  #define DEFAULT_X_MAX_TRAVEL 1000.0  // mm
  #define DEFAULT_Y_MAX_TRAVEL 1000.0  // mm
  #define DEFAULT_Z_MAX_TRAVEL 1000.0  // mm - [Z AXIS NOT USED]
  #define DEFAULT_SPINDLE_RPM_MAX 0.0  // rpm - [SPINDLE NOT USED]
  #define DEFAULT_SPINDLE_RPM_MIN 0.0  // rpm - [SPINDLE NOT USED]
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK 0
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25  // msec (0-254, 255 keeps steppers enabled)
  ...
  #define DEFAULT_INVERT_ST_ENABLE 0  // false
  #define DEFAULT_INVERT_LIMIT_PINS 0  // false
  #define DEFAULT_SOFT_LIMIT_ENABLE 0  // false (disabled)
  #define DEFAULT_HARD_LIMIT_ENABLE 0  // false (disabled)
  #define DEFAULT_INVERT_PROBE_PIN 0  // false
  #define DEFAULT_LASER_MODE 0  // false (disabled)
  #define DEFAULT_HOMING_ENABLE 0   // false (disabled)
  #define DEFAULT_HOMING_DIR_MASK 0  // move positive dir
